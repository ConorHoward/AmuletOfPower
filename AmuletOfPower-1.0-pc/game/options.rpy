...
define config.name = _("Amulet Of Power")
...
define build.name = "AmuletOfPower"
...
define config.sample_sound = "decap.wav"
...
define config.main_menu_music = "wardrums.mp3" 
...
define config.save_directory = "AmuletOfPower"
