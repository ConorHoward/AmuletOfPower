...
label splashscreen:
## play music "wardrums.mp3" fadein 3.0
    scene black
    with Pause(1)
...
label prologueone:
    play music "prologue.mp3" fadein 1.0
    scene black
...
label scene1:    
    play music "gameplay.mp3" fadein 2.0
...
label scene2:
    ...
    stop music
    play music "death.mp3" fadein 1.0
    scene death
...
label scene7:
    ...
    "Swiftly %(player_name)s takes out his dagger and slits the throat of a goblin sneaking up on him, attacking him from behind."
...
label scene9:
    ...
    menu:
        "Sorry, i would prefer to do this alone":
            jump scene11
...
label scene10:
    ...
    scene orbontable
    define choicefour = "Kill the Ivorian Mage"
...
label scene11:
    scene orbontable
    define choicefive = "Sorry, i would prefer to do this alone"
...
label fadetoblack:
    ...
    show text "Volmar and The Champion begin their training. The Chamption settled down in a small and beautiful house outside the mages order" with dissolve
    with Pause(8)
    
    hide text with dissolve
    with Pause(1)
    
    show text "Him and Volmar became great friends, such friends that Volmar allowed The Champion to take his sisters hand in marriage creating their own family in the kingdom." with dissolve
    with Pause(8)
    
    hide text with dissolve
    with Pause(1)
    
    show text "The Battle Mages never disclosed the fact they’ve found the amulet." with dissolve
    with Pause(8)
    
    hide text with dissolve
    with Pause(1)
    
    show text "The war between the Grey Order and Battle Mages still rages on as the Grey Order search for the amulet." with dissolve
    with Pause(8)
    
    hide text with dissolve
    with Pause(1)
    
    show text "The future of The Champion and the Battle Mages is uncertain, yet we know The Champion is happy with his current life as he trains in the arts of magic." with dissolve
    with Pause(8)
...
label creditsend:
    ...
    scene blackscreen #replace this with a fancy background
    with dissolve
    show theend:
    ...
    with Pause(3)
    hide theend
    show credend at Move((0.5, 2.8), (0.5, 0.0), creditsend_speed, repeat=False, bounce=False, xanchor="center", yanchor="bottom")
...
label credits:
    ...
    with Pause(3)
    hide choicedisplay
    show cred at Move((0.5, 2.8), (0.5, 0.0), credits_speed, repeat=False, bounce=False, xanchor="center", yanchor="bottom")
...
init python:
    ...
    creditsend = ('Lead Software Developer', 'Wayne Hartigan'), ('Project Leader & Software Developer', 'Conor Howard'), ('Lead Game Art Designer', 'Jake Horner'), ('Lead Graphical Interface Developer', 'Connor O Brien'), ('Lead Storyline Developer', 'Wojtek Hordyniec')
